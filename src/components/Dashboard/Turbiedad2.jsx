...
const Turbiedad2 = () => {
  ...
  const ListarMaximo = async () => {
    const request = await fetch(
      "https://5d8d-181-204-95-202.ngrok-free.app/datasnap/rest/TServerMethods/historicoMinMax/4/25/1/2",
      {
        method: "GET",
      }
    );
  ...
  const ListarMaximoSemana = async () => {
    const request = await fetch(
      "https://5d8d-181-204-95-202.ngrok-free.app/datasnap/rest/TServerMethods/historicoMinMax/5/25/1/2",
      {
        method: "GET",
      }
    );
  ...
  const ListarMaximoMes = async () => {
    const request = await fetch(
      "https://5d8d-181-204-95-202.ngrok-free.app/datasnap/rest/TServerMethods/historicoMinMax/6/25/1/2",
      {
        method: "GET",
      }
    );
  ...
  const ListarMinimo = async () => {
    const request = await fetch(
      "https://5d8d-181-204-95-202.ngrok-free.app/datasnap/rest/TServerMethods/historicoMinMax/1/25/1/2",
      {
        method: "GET",
      }
    );
  ...
  const ListarMinimoSemana = async () => {
    const request = await fetch(
      "https://5d8d-181-204-95-202.ngrok-free.app/datasnap/rest/TServerMethods/historicoMinMax/2/25/1/2",
      {
        method: "GET",
      }
    );
  ...
  const ListarMinimoMes = async () => {
    const request = await fetch(
      "https://5d8d-181-204-95-202.ngrok-free.app/datasnap/rest/TServerMethods/historicoMinMax/3/25/1/2",
      {
        method: "GET",
      }
    );
  ...
  ///Listar PROMEDIOpor DÍA
  const [promedio, SetPromedio] = useState([]);

  const ListarPromedio = async () => {
    const request = await fetch(
      "https://5d8d-181-204-95-202.ngrok-free.app/datasnap/rest/TServerMethods/historicoMinMax/7/25/1/2",
      {
        method: "GET",
      }
    );
  ...
  const ListarPromedioSemana = async () => {
    const request = await fetch(
      "https://5d8d-181-204-95-202.ngrok-free.app/datasnap/rest/TServerMethods/historicoMinMax/8/25/1/2",
      {
        method: "GET",
      }
    );
  ...
  const ListarPromedioMes = async () => {
    const request = await fetch(
      "https://5d8d-181-204-95-202.ngrok-free.app/datasnap/rest/TServerMethods/historicoMinMax/9/25/1/2",
      {
        method: "GET",
      }
    );
  ...
  const ListarLecturas = async () => {
    const request = await fetch(
      "https://5d8d-181-204-95-202.ngrok-free.app/datasnap/rest/TServerMethods/historicoLecturas/1/25/1/2",
      {
        method: "GET",
      }
    );
  ...
  const ListarSemana = async () => {
    const request = await fetch(
      "https://5d8d-181-204-95-202.ngrok-free.app/datasnap/rest/TServerMethods/historicoLecturas/2/25/1/2",
      {
        method: "GET",
      }
    );
  ...
  const ListarMes = async () => {
    const request = await fetch(
      "https://5d8d-181-204-95-202.ngrok-free.app/datasnap/rest/TServerMethods/historicolecturas/3/25/1/2",
      {
        method: "GET",
      }
    );
        ...
        <div className="row">
          <div className="card-body pt-0 p-3 text-center bg-gradient-primary3">
            <div className="nivel-rio">
              <h6 className="mb-0">TURBIEDAD AGUA CRUDA</h6>
              <span className="text-xs">
                PLANTA DE TRATAMIENTO N°2
              </span>
            </div>
          </div>
          <div className="card-body pt-0 p-3 bg-gradient-primary3 mt-1">
            ...
            <span className="text-xs">UNT (5.00 - 35,000.00)</span>
