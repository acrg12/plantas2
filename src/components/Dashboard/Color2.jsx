...
const Color2 = () => {
  ...
  const ListarMaximo = async () => {
    const request = await fetch(
      "http://181.204.95.204:8080/datasnap/rest/TServerMethods/historicoMinMax/4/1/1/2",
      {
        method: "GET",
      }
    );
...
//////////////////////////////////////////////////////////////
 ...
 const ListarMaximoSemana = async () => {
   const request = await fetch(
     "http://181.204.95.204:8080/datasnap/rest/TServerMethods/historicoMinMax/5/1/1/2",
     {
       method: "GET",
     }
   );
 ...
 const ListarMaximoMes = async () => {
   const request = await fetch(
     "http://181.204.95.204:8080/datasnap/rest/TServerMethods/historicoMinMax/6/1/1/2",
     {
       method: "GET",
     }
   );
...
//Listar MINIMO por DÍA///////////////
  ...
  const ListarMinimo = async () => {
    const request = await fetch(
      "http://181.204.95.204:8080/datasnap/rest/TServerMethods/historicoMinMax/1/1/1/2",
      {
        method: "GET",
      }
    );
...
///////////////////////////////////////
  ...
  const ListarMinimoSemana = async () => {
    const request = await fetch(
      "http://181.204.95.204:8080/datasnap/rest/TServerMethods/historicoMinMax/2/1/1/2",
      {
        method: "GET",
      }
    );
  ...
  const ListarMinimoMes = async () => {
    const request = await fetch(
      "http://181.204.95.204:8080/datasnap/rest/TServerMethods/historicoMinMax/3/1/1/2",
      {
        method: "GET",
      }
    );
...
//Listar PROMEDIO por DÍA
  ...
  const ListarPromedio = async () => {
    const request = await fetch(
      "http://181.204.95.204:8080/datasnap/rest/TServerMethods/historicoMinMax/7/1/1/2",
      {
        method: "GET",
      }
    );
  ...
  ////////////////////////////////////////////////////
    ...
    const ListarPromedioSemana = async () => {
      const request = await fetch(
        "http://181.204.95.204:8080/datasnap/rest/TServerMethods/historicoMinMax/8/1/1/2",
        {
          method: "GET",
        }
      );
    ...
    const ListarPromedioMes = async () => {
      const request = await fetch(
        "http://181.204.95.204:8080/datasnap/rest/TServerMethods/historicoMinMax/9/1/1/2",
        {
          method: "GET",
        }
      );
  ...
  const ListarLecturas = async () => {
    const request = await fetch(
      "http://181.204.95.204:8080/datasnap/rest/TServerMethods/historicoLecturas/1/1/1/2",
      {
        method: "GET",
      }
    );
  ...
  const ListarSemana = async () => {
    const request = await fetch(
      "http://181.204.95.204:8080/datasnap/rest/TServerMethods/historicoLecturas/2/1/1/2",
      {
        method: "GET",
      }
    );
  ...
  const ListarMes = async () => {
    const request = await fetch(
      "http://181.204.95.204:8080/datasnap/rest/TServerMethods/historicolecturas/3/1/1/2",
      {
        method: "GET",
      }
    );
